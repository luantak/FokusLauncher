...
// Basenames of each Icons.Outlined icon Kotlin file under commonMain (material-icons-extended-android sources).
// When the Compose BOM bumps material-icons-extended, refresh from that artifact’s -sources.jar paths.
internal object MaterialOutlinedIconIndex {

    @JvmField
    val OUTLINED_FILE_BASES: Array<String> = arrayOf(
        "Abc",
        "AcUnit",
        "AccessAlarm",
        "AccessAlarms",
